...
const ItemCard = ({ item }: ItemCardProps) => {
  ...
  return (
    <div key={item[0]} className="border-2 border-gold-light rounded-sm">
      <Link href={`/items/${item[0]}`}>
        ...
        />
        <span className="block text-center font-bold bg-black">
          {item[1].name}
        </span>

        <span className="flex justify-center text-center font-bold bg-black">
